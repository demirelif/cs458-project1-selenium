...
To run the test code, you should open it in a Java IDK with VCS.
After that, you need to make sure that the main source code is available in localhost in the following directory:
